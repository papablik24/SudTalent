                  ...
                  <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                    ...
                    <div className="space-y-2">
                      ...
                      <div className="relative group">
                        <input type="email" value={email} onChange={e => setEmail(e.target.value.slice(0, 35))} maxLength={35} className="sud-input w-full pr-16" placeholder="admin@sudamericanvoices.com" />
